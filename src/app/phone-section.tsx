  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      {/* Header Section */}
          ...
          <p className="text-xl text-nowrap md:text-2xl text-dblue moul-regular sm:ml-6 md:m-2">
          សិរីសួស្ដី​អាពាហ៍ពិពាហ៍
        </p>
        <p className="text-xl md:text-2xl text-dblue moul-regular sm:ml-6 md:mr-4 mt-5">
          សូម​គោរពអញ្ជើញ​
        </p>
      </div>
          ...
          <h2 className="text-r-2xl moul-regular text-dblue whitespace-nowrap break-words kantumruy-pro">
              <strong>{to ? ` ${to}` : ""}</strong>
            </h2>
          </div>
        </div>
